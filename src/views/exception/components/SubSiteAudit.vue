...
export default {
  props: {
    beginTime: {
      type: String,
      default:'2023-11-01 00:00:00'
    },
    endTime: {
      type: String,
      default:'2023-11-11 00:00:00',
    },
    exceptionType: {
      type: Number,
      default: 0
  ...
  mounted() {
    ...
    this.$watch(() => [this.beginTime, this.endTime, this.exceptionType], () => {
      // 根据开始和结束时间,异常类型
      this.form.exceptionName = []
      this.form.exceptionName.push(this.exceptionType)
  ...
  methods: {
    ...
    gethasCheckedNumByTime() {
      console.log('qqq',this.beginTime, this.endTim);
      ...
      <el-card>
        <el-form :inline="true">
          <div class="head-container-text">
            ...
            <el-form-item>
              <ExceptionType @submit-value="(n) => (form.exceptionName = n)" :exception="exceptionType" :isDisabled="true"></ExceptionType>
            </el-form-item>
          </div> 
